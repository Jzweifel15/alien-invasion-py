...
def run_game():
  ...
  while True:
    game_fns.check_events(ai_settings, screen, stats, play_button, ship, aliens, bullets)
    ...
    game_fns.update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button)
